...
#___PATH CROSSING___#
    ...
    def pathTwoBetter(self, path_1 = Path(), path_2 = Path()):   #Analizuje ściezkę wybierając lepsze punkty
        tmp_path = Path(self.path_length)
        tmp_path.start_point = path_1.start_point
        tmp_path.end_point = path_1.end_point
        temp_twos_1=Path(0)
    ...
    def pathThreeBetter(self, path_1 = Path(), path_2 = Path()):   #Analizuje ściezkę wybierając lepsze pary punktów
        tmp_path = Path(self.path_length)
        tmp_path.start_point = path_1.start_point
        tmp_path.end_point = path_1.end_point
        temp_three_1=Path(1)
